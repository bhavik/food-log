...
import { PlusCircleIcon, ClockIcon, PieChartIcon } from 'lucide-react';

interface BottomNavProps {
  activeTab: 'track' | 'history' | 'nutrition';
  setActiveTab: (tab: 'track' | 'history' | 'nutrition') => void;
}
      ...
      <div className="max-w-xl mx-auto px-6 py-4 flex justify-center">
        <div className="flex items-center gap-6 sm:gap-8">
          ...
          <button
            ...
            className={`flex flex-col items-center gap-1.5 transition-smooth ${
              activeTab === 'nutrition' ? 'nav-tab-active' : 'text-stone-500 hover:text-stone-400'
            }`}
          >
            <PieChartIcon size={24} strokeWidth={activeTab === 'nutrition' ? 2.5 : 2} />
